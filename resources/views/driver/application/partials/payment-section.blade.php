    ...
    <div class="bg-white text-gray-800 rounded-lg p-6 mb-4">
        <div class="flex items-center justify-between mb-4 pb-4 border-b">
            ...
            <div class="flex items-center space-x-2">
                <a href="{{ route('driver.payment.preview', [$application, $application->latestPayment]) }}" target="_blank" class="inline-flex items-center px-3 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition text-sm font-semibold" title="Preview PDF">
                    <i class="fas fa-eye mr-2"></i>View PDF
                </a>
                <a href="{{ route('driver.payment.download', [$application, $application->latestPayment]) }}" class="inline-flex items-center px-3 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition text-sm font-semibold" title="Download PDF">
